...
//Now testing the deserialization of the binary
itemData = new ITEM_DATA_TYPE();

// Payload has the binary deserialization results
var data = loader.loadFromBinaryFile("C:\\Users\\Shadow\\Desktop\\uaf.git\\uaf-port\\src\\UAFLib\\data\\items.bin");
itemData.LoadFromLoader(data);

Globals.ASSERT(itemData.PeekItem("Long Sword").Wpn_Type == weaponClassType.HandCutting, "TestLoadItems.js - 0");
Globals.ASSERT(itemData.GetCount() == 540, "TestLoadItems.js - 1");
Globals.ASSERT(itemData.PeekItem("Long Sword") != null && itemData.PeekItem("Long Sword").m_uniqueName != null, "TestLoadItems.js - 2");
Globals.ASSERT(itemData.PeekItem("Long Sword").Dmg_Dice_Sm == 8, "TestLoadItems.js - 3");