...
Globals.ASSERT(Deserialize("Druid.chr") == DRUID_RESULT);
Globals.ASSERT(Deserialize("Priestess.chr") == PRIESTESS_RESULT);
Globals.ASSERT(Deserialize("Rogue.chr") == ROGUE_RESULT);
Globals.ASSERT(Deserialize("Warrior.chr") == WARRIOR_RESULT);
