...
enum SUBOPS {
  ...
  //SUBOP_GET_CHAR_MAGICUSERLVL   =0x074,
...
//  SUBOP_GET_SPELLGROUP_SA           =0x19d,
  SUBOP_GET_MONSTERTYPE_SA          =0x19e,
  SUBOP_GET_RACE_SA                 =0x19f,
  SUBOP_GET_ABILITY_SA              =0x1a0,
//  SUBOP_GET_TRAIT_SA                =0x1a1,
  SUBOP_GET_CLASS_SA                =0x1a2,
  //SUBOP_SET_ITEM_SA                 =0x1a3,
  SUBOP_SET_CHARACTER_SA            =0x1a4,
  //SUBOP_SET_SPELL_SA                =0x1a5,
  SUBOP_SA_BASECLASS_GET            =0x1a5,
  //SUBOP_SET_SPELLGROUP_SA           =0x1a6,
  SUBOP_GET_BASECLASS_SA            =0x1a6,
  //SUBOP_SET_MONSTERTYPE_SA          =0x1a7,
  //SUBOP_SET_RACE_SA                 =0x1a8,
  //SUBOP_SET_ABILITY_SA              =0x1a9,
  //SUBOP_SET_TRAIT_SA                =0x1aa,
  //SUBOP_SET_CLASS_SA                =0x1ab,
//  SUBOP_SA_SPELLGROUP_GET           =0x1ac,
  SUBOP_SA_MONSTERTYPE_GET          =0x1ad,
  SUBOP_SA_RACE_GET                 =0x1ae,
  SUBOP_SA_ABILITY_GET              =0x1af,
//  SUBOP_SA_TRAIT_GET                =0x1b0,
  //SUBOP_DELETE_SPELLGROUP_SA        =0x1b1,
  //SUBOP_DELETE_MONSTERTYPE_SA       =0x1b2,
  //SUBOP_DELETE_RACE_SA              =0x1b3,
  //SUBOP_DELETE_ABILITY_SA           =0x1b4,
  //SUBOP_DELETE_TRAIT_SA             =0x1b5,
  SUBOP_DELETE_CLASS_SA             =0x1b6,
  //deprecated SUBOP_GetSpellbook                =0x1b7,
